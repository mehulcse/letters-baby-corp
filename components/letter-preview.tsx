        ...
        <div className="flex-grow space-y-4">
          {data.language === "hindi" && (
            <>
              ...
              <p>क्या आपको हमारा उत्पाद पसंद आया? जब आप नए क्रैडल का उपयोग करें, तो आपके अनुभव के बारे में जानकर हमें खुशी होगी। अगर आपको थोड़ा समय मिले, तो कृपया अपने विचार हमारे साथ साझा करें। आपकी समीक्षा हमें इस उत्पाद में सुधार करने और अन्य खरीदारों की मदद करने में सहायता करेगी। यदि आप हमारे उत्पाद से प्रसन्न हैं, तो अमेज़न पर 5-स्टार रेटिंग देकर हमें खुशी होगी! आपकी सकारात्मक प्रतिक्रिया अन्य ग्राहकों को बेबी कॉर्प पर विश्वास के साथ निर्णय लेने में मदद करती है।</p>
          ...
          {data.language === "gujarati" && (
            <>
              ...
              <p>આશા છે કે ઘોડિયા નું ધીમું ધીમું હલનચલન, તમારા ઘરમાં શાંતિ અને આનંદ લાવશે. �� નવું ઉમેરણ તમારા દૈનિક જીવનને વધુ આરામદાયક અને સુખદ બનાવશે, અને તમને ખાતરી મળશે કે તમારા પરિવારને શ્રેષ્ઠ સગવડ મળી છે.</p>
              
              <p>અમારા પ્રોડક્ટથી ખુશ છો? તમારો અનુભવ શેર કરો 📹</p>
              
              <p>જો આ પ્રોડક્ટથી તમે ખુશ છો તો મારા અનુવ અંગે જાણીને અમને આદ થશે. જો તમને થોડીવાર મળે, તો કૃપા કરીને તમારા અભિપ્રાય સાથે અમને 5-star મૂલ્યાંકન આપો. તમારો રિવ્યૂ અમને આ પ્રોડક્ટ સુધારવામાં અનેય ખરીદદારોને દદરૂપ થશે.</p>
          ...
          {data.language === "marathi" && (
            <>
              <p>{data.localName},</p>
              <p>बेबी कॉर्प ुटुंबात तुमचं स्वा��त आहे!</p>
        ...
        <div className="flex-grow space-y-8">
          ...
          <div className="space-y-4 pt-8 border-t">
            ...
            {data.language === "marathi" && (
              <>
                <p>{data.localName},</p>
                <p>Baby Corp कुटुंबात तुमचं स्वागत आहे! महारा��्ट् आमचे प्रिय ग्राहक म्हणून, आम्ही तुमच्यासोबत हा महत्त्वपूर्ण क्षण साजरा करत आहोत आणि तुमच्या Automatic Cradle Kit सोबत एक खास सरप्राईज गिफ्ट देत आहोत. तुम्हाला ते आवडेल अशी आम्हाला आशा आहे!</p>
                <p>ध्यवाद!</p>
                <p>आपुलकीने,<br />
                बेबी कॉर्प (Baby Corp<sup>TM</sup>)<br />
                +91-972-244-1030<br />
  ...
  const renderGenericLetter = () => (
    <div className="p-8 min-h-[297mm] flex flex-col print-page bg-white font-[family-name:var(--font-geist-sans)]">
      ...
      <div className="flex-grow space-y-4">
        ...
        <div className="pt-8">
          <p className="mb-4"><span className="font-semibold">क्या आपको हमारा उत्पाद पसंद आया?</span> तो आपके अनुभव के बारे में जानकर हमें खुशी होगी। अगर आपको थोड़ा समय मिले, तो कृपया अपने विचार हमारे साथ साझा करें। आपकी समीक्षा हमें इस उत्पाद में सुधार करने और अन्य खरीदारों की मदद करने में सहायता करेगी। यदि आप हमारे उत्पाद से प्रसन्न हैं, तो अमेज़न पर 5-स्टार रेटिंग देकर हमें खुशी होगी! आपकी सकारात्मक प्रतिक्रिया अन्य ग्राहकों को बेबी कॉर्प पर विश्वास के साथ निर्णय लेने में मदद करती है।</p>
